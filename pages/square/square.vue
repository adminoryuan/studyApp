<template>
	<view>
		<!-- <van-search v-model="queryParms.title" @input="list" placeholder="请输入标题" /> -->
...
<script>
	...
	export default {
		...
		methods: {
			...
			list() {
				this.$request('/articles/list', "get",this.queryParms).then(res => {
