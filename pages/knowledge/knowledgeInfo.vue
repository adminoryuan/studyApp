  ...
  <view class="article-detail">
    <view class="article-content">
      ...
      <view class="author-info">
        ...
        <view class="author-name">{{ articleInfo.anthorName }}</view>
        <view class="publish-time">{{ formatDate(articleInfo.createDate) }}</view>
      </view>
      <view class="content" v-html="articleInfo.body"></view>
    </view>
...
export default {
  ...
  methods: {
	...
	articlesInfo(){
		...
		this.$request('/system/base/'+this.articleId,"get").then(res=>{
